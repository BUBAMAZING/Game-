...
function send(){
    ...
    console.log(charAt3);
    romoveCharAt1=word.replace(charAt1,"_");
    romoveCharAt2=romoveCharAt1.replace(charAt2,"_");
    romoveCharAt3=romoveCharAt1.replace(charAt3,"_");
    questionWord="<h4 id="word_display">Q."+romoveCharAt3+"</h4>";
    inputbox="answer:<input type="text" id="inputbox">";
